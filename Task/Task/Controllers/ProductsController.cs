...
namespace Task.Controllers
{
    public class ProductsController : Controller
    {
        ...
        // GET: Products
        [Authorize(Roles = "authenticated user")]
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Price,ProductCategoriesId")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Price,ProductCategoriesId")] Product product)
        {
            if (ModelState.IsValid)
            {
